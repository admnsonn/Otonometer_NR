    ...
    <div>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="flex justify-center items-center gap-[200px] mt-[10px] px-[205px] h-[531px]">
            <img src={logo3d} alt="" className="flex items-center" />
            <div className="absolute w-full mb-[300px] ml-[107%] text-secondary text-[50px] font-bold">
              Tentang Kami
            </div>
            <div className="w-full md:w-[950px] mt-[40px] mr-[10px] text-secondary text-[16px] text-justify">
