...
const Jelajahprofil = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem("idprovinsi") !== null) {
      fetch(
        "https://api.otonometer.neracaruang.com/api/cities?province_id=" +
  ...
  function updatePejabat(wilayah_id, tahun) {
    fetch(
      "https://api.otonometer.neracaruang.com/api/pemda?wilayah_id=" +
        wilayah_id +
        "&tahun=" +
        tahun
    )
  ...
  function updateDPRD(wilayah_id, tahun) {
    fetch(
      "https://api.otonometer.neracaruang.com/api/dewan?wilayah_id=" +
        wilayah_id +
        "&tahun=" +
        tahun
    )
