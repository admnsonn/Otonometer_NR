  ...
  render() {
    return (
      <div className="flex flex-col md:flex-row h-screen">
        ...
        <div className="hidden md:block md:w-100% bg-gray-200 flex justify-center items-center">
          <img src={Illustration} alt="Illustration" className="max-h-full" style={{ maxWidth: '100%' }} />
        </div>
        ...
        <div className="md:w-1/2 flex justify-center items-center">
          <form onSubmit={this.handleSubmit} className="max-w-md bg-white rounded px-8 pt-6 pb-8">
            ...
            <p className="text-sm mb-8 text-center" style={{ color: '#064878' }}>Masuk ke akun Anda untuk mengakses <span className="font-bold" style={{ color: '#24445A' }}>fitur lainnya</span> Otonometer</p>
            <div className="mb-4">
            ...
            <div className="flex flex-col items-center mt-4 space-y-4">
              <button className="bg-white border-2 border-A7A7A7 py-2 px-4 rounded flex items-center  focus:outline-none focus:shadow-outline w-full" onClick={() => {}}>
                <NeracaIcon className="w-5 h-5 mr-2" />
                <span style={{ fontSize: '16px', color: '#A7A7A7' }} className="font-normal">Masuk dengan Neraca Ruang</span>
              </button>
              <button className="bg-white border-2 border-A7A7A7 py-2 px-4 rounded flex items-center focus:outline-none focus:shadow-outline w-full" onClick={() => {}}>
                <AppleIcon className="w-5 h-5 mr-2" />
                <span style={{ fontSize: '16px', color: '#A7A7A7', textAlign: 'center' }} className="font-normal">Masuk dengan Apple</span>
              </button>
              <button className="bg-white border-2 border-A7A7A7 py-2 px-4 rounded flex items-center  focus:outline-none focus:shadow-outline w-full" onClick={() => {}}>
                <GoogleIcon className="w-5 h-5 mr-2" />
                <span style={{ fontSize: '16px', color: '#A7A7A7', textAlign: 'center' }} className="font-normal">Masuk dengan Google</span>
              </button>
              <button className="bg-white border-2 border-A7A7A7 py-2 px-4 rounded flex items-center  focus:outline-none focus:shadow-outline w-full" onClick={() => {}}>
                <MicrosoftIcon className="w-5 h-5 mr-2" />
                <span style={{ fontSize: '16px', color: '#A7A7A7', textAlign: 'center' }} className="font-normal">Masuk dengan Microsoft</span>
              </button>
            </div>
            ...
            <div className="flex items-center justify-center mt-4">
              ...
              <span className="ml-1">
                <u className="font-bold cursor-pointer" style={{ color: '#24445A' }}>Daftar</u>
              </span>
            </div>
          </form>
        </div>
